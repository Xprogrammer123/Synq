  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-6">
      <div className="w-full max-w-lg rounded-3xl bg-white shadow-2xl p-10 relative">
        ...
        <h1
          className="text-3xl font-bold text-center text-black text-primary">
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center gap-2 rounded-xl border border-gray-200 bg-violet-100 px-4 py-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 rounded-xl border border-gray-200 bg-violet-100 px-2 py-2 mb-1">
              ...
              <button
                type="button"
                onClick={addEmail}
                className="flex items-center justify-center bg-gray-50 text-violet-600 p-2 rounded-lg hover:bg-violet-500 hover:text-white "
              >
              ...
              <div className="relative mt-3">
                ...
                >
                  {emails.slice(0, visibleCount).map((email, i) => (
                    <div
                      key={i}
                      className="flex items-center justify-between rounded-xl border border-violet-700 bg-violet-100 px-4 py-2 mb-2"
                    >
                      <span className="text-gray-800 font-semibold">{email}</span>
                      <button
                        type="button"
                        onClick={() => removeEmail(i)}
                        className="w-8 h-8 flex items-center justify-center rounded-md border border-gray-200 text-black hover:bg-violet-500"
                      >
