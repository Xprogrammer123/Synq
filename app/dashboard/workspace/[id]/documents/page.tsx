...
import DocumentUtilityTab from "./components/DocumentUtilityTab";

const DocumentsPage = () => {
  return (
    <div className="bg-[#0d0d0d] text-white min-h-screen px-8 py-6">
      {/* Top Utilities Bar */}
      <DocumentUtilityTab />

      {/* Main Document Content */}
      <div className="mt-8 max-w-3xl mx-auto bg-[#141414] border border-white/10 rounded-2xl p-8">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-semibold">Marketing Strategy Q4</h2>
          <button className="text-xs bg-white/10 px-3 py-1 rounded-md border border-white/10">
            Source: Notion
          </button>
        </div>
