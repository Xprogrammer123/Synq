...
export default function Sidebar() {
  ...
  return (
    <aside
      className={cn(
        "h-screen flex flex-col text-gray-200 border-r pr-2 border-white/5 py-4",
        collapsed ? "w-18" : "w-auto"
      )}
    >
      <nav className="flex-1 overflow-y-auto space-y-1">
        <div className="mb-4">
          <button
            ...
            className={cn(
              "flex items-center gap-3 px-3 py-2 border border-white/5 rounded-xl hover:bg-[#151515] ml-2 text-sm w-56",
        ...
        {NAV.map((n) => {
          ...
          return (
            <Link
              ...
              className={cn(
                "flex items-center gap-3 px-3 py-3 rounded-lg border border-white/0 hover:bg-[#151515] hover:text-[#6B48FF] ml-2 text-sm",
                isActive
                  ? "text-[#6B48FF] bg-[#151515] border-white/5"
                  : "text-zinc-600",
                collapsed ? "justify-center" : ""
              )}
            >
